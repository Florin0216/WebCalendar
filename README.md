This is a Spring Boot-based web application designed for managing events in a simple calendar format. It provides a set of RESTful APIs to add, retrieve, and delete events stored in a database. 
